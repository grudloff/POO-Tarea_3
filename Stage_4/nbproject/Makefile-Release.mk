...
${OBJECTDIR}/_ext/497b77f9/Maze.o: ../Tarea\ 3\ POO/Stage_4/Maze.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/497b77f9/Maze.o ../Tarea\ 3\ POO/Stage_4/Maze.cpp

${OBJECTDIR}/_ext/497b77f9/MyWorld.o: ../Tarea\ 3\ POO/Stage_4/MyWorld.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/497b77f9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/497b77f9/MyWorld.o ../Tarea\ 3\ POO/Stage_4/MyWorld.cpp

${OBJECTDIR}/_ext/497b77f9/Robot.o: ../Tarea\ 3\ POO/Stage_4/Robot.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/497b77f9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/497b77f9/Robot.o ../Tarea\ 3\ POO/Stage_4/Robot.cpp

${OBJECTDIR}/_ext/497b77f9/Stage3.o: ../Tarea\ 3\ POO/Stage_4/Stage3.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/497b77f9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/497b77f9/Stage3.o ../Tarea\ 3\ POO/Stage_4/Stage3.cpp

${OBJECTDIR}/_ext/497b77f9/Vector2D.o: ../Tarea\ 3\ POO/Stage_4/Vector2D.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/497b77f9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/497b77f9/Vector2D.o ../Tarea\ 3\ POO/Stage_4/Vector2D.cpp

${OBJECTDIR}/DocumentedMaze.o: DocumentedMaze.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DocumentedMaze.o DocumentedMaze.cpp
